...
Generated: 2026-07-27T15:56:30  |  seeds: [1588, 2026, 7, 42, 101, 900, 31415, 27182]
...
- Discriminator accuracy: **0.979 ± 0.007**
- Discriminator macro-F1: **0.978 ± 0.007**
- Discriminator ROC-AUC (H1): **0.998 ± 0.001**
- Governed-loop recovery success: **0.950 ± 0.015**
- Governed-loop wrong-action rate: **0.044 ± 0.018**
- Governed-loop mean MTTR (s): **0.580 ± 0.018**
...
Discriminator trained with an entire attack family removed, then tested on it (can it catch an attack type it never saw?):
  ...
  - held out **ptp_spoof** -> recall on unseen family: 0.872 (n=179)
  - held out **ptp_replay** -> recall on unseen family: 0.480 (n=179)

## 3. Digital-twin validation

- Twin vs simulator action-ranking: Pearson r = **0.998**, Spearman r = **0.873**, MAE = 54.51 ns (twin action model is consistent with ground-truth simulator physics).
- Fidelity-score behaviour vs telemetry degradation: corr_fidelity_vs_pdv_std=-0.712, corr_fidelity_vs_seq_regressions=-0.901.
