...
Generated: 2026-08-05T15:34:07  |  seeds: [1588, 2026, 7, 42, 101, 900, 31415, 27182]
...
- Discriminator accuracy: **0.988 ± 0.005**
- Discriminator macro-F1: **0.987 ± 0.005**
- Discriminator ROC-AUC (H1): **0.999 ± 0.000**
- Governed-loop recovery success: **0.980 ± 0.022**
- Governed-loop wrong-action rate: **0.016 ± 0.019**
- Governed-loop mean MTTR (s): **0.835 ± 0.024**
...
Discriminator trained with an entire attack family removed, then tested on it (can it catch an attack type it never saw?):
  ...
  - held out **replay** (`ptp_replay`) -> recall on unseen family: 0.000 (n=179)
...
- Fidelity-score behaviour vs telemetry degradation: corr_fidelity_vs_pdv_std=-0.730, corr_fidelity_vs_seq_regressions=-0.901.
